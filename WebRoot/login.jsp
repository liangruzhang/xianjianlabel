			...
			<DIV class=left>
				<DIV class=right>
					...
					<DIV class=content>
						...
						<FORM class=signin id=signin action="/login" method=post>
							...
							<DIV class=row>
								...
								<DIV class=cell><INPUT class=entry maxLength=30 name="companyCode" value='lifetech' readonly="readonly"></DIV>
							</DIV>						
							<DIV class=row>
